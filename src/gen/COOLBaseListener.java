package gen;// Generated from C:/Users/my/Desktop/proje compiler/cool/grammer\COOL.g4 by ANTLR 4.7.2
...
public class COOLBaseListener implements COOLListener {
	...
	@Override public void enterClasses(COOLParser.ClassesContext ctx) {
		...
		scope1.pre=scope;
		scope=scope1;
		//ClassDec classDec=new ClassDec("class",ctx.classDefine().TYPEID(1).getText(),ctx.classDefine().TYPEID(2).getText());
		//System.out.println(classDec.getString());
